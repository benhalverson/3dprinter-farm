...
vi.mock('../../src/utils/crypto', () => ({
	decryptField: vi.fn().mockImplementation(async (value: string) => value.replace('encrypted-', '')),
	encryptField: vi.fn().mockImplementation(async (value: string) => `encrypted-${value}`),
}));
